...
contract MultiSig {
    ...
    constructor(address[] memory _owners, uint _numConfirmationsRequired){
        ...
        require(_numConfirmationsRequired>0 && numConfirmationsRequired<=_owners.length,"Number of confirmations are not in sync with number of owners");
   ...
   function submitTransaction(address _to) public payable{
    require(_to!=address(0),"Inalid Receiver's address");
